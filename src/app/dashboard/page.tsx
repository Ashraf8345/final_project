...
export default function DashboardPage() {
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-300">
      ...
      {/* Empty State */}
      <div className="flex flex-col items-center justify-center border border-dashed border-border/60 bg-zinc-900/10 rounded-2xl p-12 text-center max-w-2xl mx-auto shadow-sm my-8">
        <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-zinc-900 border border-border/40 text-muted-foreground mb-6 shadow-inner">
        ...
        <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
          ...
          <Button variant="outline" className="gap-2 text-sm font-semibold border-border/80 hover:bg-zinc-900/60 h-10 px-6 rounded-lg" disabled>
