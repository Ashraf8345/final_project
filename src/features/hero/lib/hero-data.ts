...
export const heroHeadline =
  "Your GitHub profile, transformed into a portfolio that gets you hired" as const;

export const heroDescription =
  "Devora analyzes your GitHub profile and generates a polished portfolio, resume, and cover letter — optimized for recruiters and ready to share in minutes." as const;

export const heroActions: Readonly<
  ...
  pinnedRepos: [
    {
      name: "photoloop",
      description:
        "A modern platform for sharing photos, loops, and stories with the people who matter most",
      language: "TypeScript",
    ...
    },
    {
      ...
      description:
        "Authentication system demo with session management and secure login flows",
      language: "TypeScript",
      languageColor: "oklch(0.65 0.12 250)",
      stars: 0,
      forks: 0,
