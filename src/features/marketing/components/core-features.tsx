  ...
  const categories = [
    {
      ...
      description:
        "No manual data entry. We parse your public repositories, contributions, pinned projects, and profile details directly from GitHub API.",
      features: [
        ...
        <div className="flex h-64 items-center justify-center bg-muted/10 rounded-xl border border-border/40 p-6">
          <div className="w-full max-w-sm space-y-4 bg-background border border-border/50 rounded-xl p-5 shadow-sm">
            <div className="flex items-center gap-3">
              ...
              <Badge
                variant="secondary"
                className="text-[9px] h-4.5 bg-emerald-500/10 text-emerald-500 border-none"
              >
                Active Sync
              </Badge>
            </div>
    ...
    },
    {
      ...
      description:
        "Our specialized AI reads your project descriptions and codebase tags to compose high-impact summaries that grab a recruiter's attention.",
      features: [
        ...
        <div className="flex h-64 items-center justify-center bg-muted/10 rounded-xl border border-border/40 p-6">
          <div className="w-full max-w-sm space-y-4 bg-background border border-border/50 rounded-xl p-5 shadow-sm">
            ...
            <div className="p-3 bg-muted/30 border border-border/40 rounded-lg text-xs leading-relaxed text-foreground/90">
              &quot;A passionate software engineer in Egypt building modern user
              experiences using{" "}
              <span className="font-semibold text-amber-500">React</span> and{" "}
              <span className="font-semibold text-amber-500">Next.js</span>
              ...&quot;
            </div>
    ...
    },
    {
      ...
      description:
        "Rearrange sections, toggle information, customize accent palettes, and tweak layouts using modular block controls.",
      features: [
    ...
    },
    {
      ...
      description:
        "Instantly deploy your web presence to Vercel's global edge network. Fully optimized, secure, and ready to share.",
      features: [
      ...
      <Container size="wide" className="space-y-16">
        <div className="text-center max-w-3xl mx-auto space-y-4">
          ...
          <p className={cn(bodyClassNames.lead)}>
            Devora integrates all the tools you need to establish a highly
            professional, lightning-fast digital footprint.
          </p>
        </div>
        ...
        <div className="w-full space-y-10">
          ...
          >
            ...
            <div className="space-y-6">
              <h3 className={cn(headingClassNames.h2)}>
                {activeCategory.title}
              </h3>
              <p className={cn(bodyClassNames.base)}>
