  ...
  const templates: Template[] = [
    {
      ...
      name: "Sleek Dark",
      description:
        "A gorgeous dark-mode layout designed with deep hues, crisp borders, and subtle glowing accent spots. Optimized for design engineers.",
    ...
    },
    {
      ...
      description:
        "Clean typography, high-contrast monochrome tones, and spacious grids. Designed for minimalists and backend engineers.",
      inspiration: "Linear",
    ...
    },
    {
      ...
      description:
        "Large, bold sans-serif display type paired with fluid, colorful gradient backdrops and responsive creative grids.",
      inspiration: "Stripe",
      ...
      previewStyle: (
        <div className="relative h-48 w-full bg-zinc-50 dark:bg-zinc-950 rounded-t-xl border-b border-border/40 p-4 overflow-hidden flex flex-col justify-between">
          ...
          <div className="flex justify-between items-center">
            <div className="size-6 rounded-full bg-emerald-500/10 flex items-center justify-center text-emerald-500 text-[10px] font-bold">
              YD
            </div>
      ...
      <Container size="wide" className="space-y-16">
        <div className="text-center max-w-3xl mx-auto space-y-4">
          ...
          <p className={cn(bodyClassNames.lead)}>
            Choose a design system that fits your personal brand. All templates
            are fully responsive, accessible, and fast.
          </p>
        </div>
        ...
        >
          {templates.map((tpl) => (
            ...
            >
              <Card className="flex py-0 flex-col h-full overflow-hidden border-border/50 bg-card/40 hover:border-border hover:shadow-lg transition-all duration-300">
                {tpl.previewStyle}
