      ...
      <Container size="wide" className="space-y-16">
        <div className="text-center max-w-3xl mx-auto space-y-4">
          ...
          <p className={cn(bodyClassNames.lead)}>
            Recruiters don&apos;t read JSON or crawl repositories. PortfolioGenie transforms your raw profile data into a high-converting editorial developer portfolio.
          </p>
        </div>
        ...
        <div className="grid gap-8 items-center lg:grid-cols-2">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between px-2">
              ...
              <Badge variant="outline" className="text-[10px] h-4.5 font-mono">Input</Badge>
            </div>
          ...
          <div className="space-y-4 relative">
            <div className="flex items-center justify-between px-2">
              ...
              <Badge variant="default" className="text-[10px] h-4.5 font-mono shadow-sm">AI Transformed</Badge>
            </div>
            ...
            <Card className="relative overflow-hidden border-border/50 bg-card p-6 shadow-xl space-y-6">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h4 className="font-heading text-base font-bold">Yousef Dawood</h4>
                  <p className="text-xs text-muted-foreground">React & Next.js Engineer · Egypt</p>
                </div>
              </div>

              {/* Bio summary */}
              <div className="space-y-2">
                <span className="text-[9px] font-mono uppercase tracking-wider text-muted-foreground">Summary</span>
                <p className="text-xs leading-relaxed text-muted-foreground">
                  Creative software engineer focusing on high-performance React applications, type-safe Next.js architecture, and interactive web tools.
                </p>
              </div>

              {/* Featured Project Showcase */}
              <div className="space-y-3">
                <span className="text-[9px] font-mono uppercase tracking-wider text-muted-foreground">Featured Project</span>
                <div className="p-3 border border-border/50 bg-muted/30 rounded-lg space-y-1.5">
                  ...
                  <p className="text-[11px] leading-relaxed text-muted-foreground">
                    A modern platforms for sharing photos and stories with the people who matter most, utilizing serverless architecture.
                  </p>
                </div>
              </div>
