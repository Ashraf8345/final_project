...
const faqItems: readonly FaqItem[] = [
  {
    question: "How does Devora use my GitHub data?",
    answer:
  ...
  },
  {
    ...
    answer:
      "Yes. On the Pro plan, you can connect any custom domain you own. We handle SSL certificate provisioning, CNAME configuration, and global CDN distribution automatically. Free plans use a Devora.dev subdomain.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Yes. The free plan includes one portfolio site, three templates, AI-generated bio, and a Devora.dev subdomain. No credit card required. Upgrade to Pro anytime for custom domains, AI resumes, and unlimited sites.",
  },
  {
      ...
      <Container size="page" className="space-y-16">
        <div className="text-center max-w-3xl mx-auto space-y-4">
          ...
          <p className={cn(bodyClassNames.lead)}>
            Everything you need to know about Devora. Can&apos;t find the
