  ...
  const cards: BentoCardProps[] = [
    {
      ...
      description: "Securely link your GitHub account. We analyze only your public activity and public repositories.",
          ...
          <div className="relative w-full max-w-[280px] sm:max-w-[320px] rounded-xl border border-border/50 bg-background/60 p-4.5 shadow-sm space-y-4">
            <div className="flex items-center justify-between border-b border-border/40 pb-3">
              <div className="flex items-center gap-3">
                ...
                <div className="min-w-0">
                  <p className="text-xs font-semibold text-foreground truncate">Yousef Dawood</p>
                  <p className="text-[10px] text-muted-foreground truncate">@yousefdawood7</p>
                </div>
              </div>
              <Badge variant="secondary" className="gap-1 text-[9px] h-5 bg-emerald-500/10 text-emerald-500 border-none px-2">
            ...
            <div className="grid grid-cols-2 gap-2 text-center text-[10px]">
              <div className="bg-muted/30 border border-border/30 rounded-lg py-2">
                <span className="block text-muted-foreground text-[8px] uppercase tracking-wider">Repositories</span>
                <span className="font-semibold text-foreground text-sm font-mono">21</span>
              </div>
              <div className="bg-muted/30 border border-border/30 rounded-lg py-2">
                <span className="block text-muted-foreground text-[8px] uppercase tracking-wider">Stars</span>
                <span className="font-semibold text-foreground text-sm font-mono">2</span>
              </div>
            </div>
            <Button size="sm" className="w-full gap-1.5 text-[10px] h-8.5 pointer-events-none bg-foreground text-background font-medium">
        ...
        <div className="flex flex-1 flex-col justify-center p-4 mt-2 w-full">
          <div className="w-full max-w-[280px] sm:max-w-[320px] mx-auto rounded-xl border border-border/50 bg-background/60 p-4.5 shadow-sm space-y-3.5">
            <div className="flex items-center justify-between border-b border-border/40 pb-2.5">
              <span className="text-[9px] font-mono text-muted-foreground uppercase tracking-wider">Analysis Engine</span>
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-1.5">
                <div className="flex justify-between text-[9px] text-muted-foreground">
                  ...
                  <span className="font-semibold text-foreground">100% Analyzed</span>
                </div>
                <div className="h-2 w-full bg-muted rounded-full overflow-hidden flex">
                  <div className="h-full bg-sky-500" style={{ width: "68%" }} title="TypeScript (68%)" />
                  <div className="h-full bg-indigo-500" style={{ width: "22%" }} title="React (22%)" />
                  <div className="h-full bg-cyan-400" style={{ width: "10%" }} title="Tailwind (10%)" />
                </div>
                <div className="flex gap-3 text-[8px] text-muted-foreground font-mono">
                  <span className="flex items-center gap-1"><span className="size-1.5 rounded-full bg-sky-500" />TS 68%</span>
                  <span className="flex items-center gap-1"><span className="size-1.5 rounded-full bg-indigo-500" />React 22%</span>
                  <span className="flex items-center gap-1"><span className="size-1.5 rounded-full bg-cyan-400" />Tailwind 10%</span>
                </div>
              </div>
    ...
    },
    {
      ...
      description: "Fine-tune generated descriptions, choose from premium design systems, and toggle sections to match your goals.",
        ...
        <div className="flex flex-1 items-center justify-center p-4 mt-2 w-full">
          <div className="w-full max-w-[280px] sm:max-w-[320px] rounded-xl border border-border/50 bg-background/60 p-4.5 shadow-sm space-y-4">
            <div className="flex items-center gap-2 border-b border-border/40 pb-2.5">
              ...
              <span className="text-[10px] font-medium text-muted-foreground">Editor Preferences</span>
            </div>
            
            <div className="space-y-3.5">
              {/* Colors Row */}
              <div className="space-y-1.5">
                <span className="block text-[9px] text-muted-foreground font-mono uppercase tracking-wider">Accent Palette</span>
              ...
              <div className="space-y-2 border-t border-border/30 pt-3">
                <div className="flex items-center justify-between text-xs">
                  <span className="text-muted-foreground">Show Repositories</span>
                  <span className="size-2 rounded-full bg-emerald-500" />
                </div>
                <div className="flex items-center justify-between text-xs">
                  <span className="text-muted-foreground">Show Contributions</span>
                  <span className="size-2 rounded-full bg-emerald-500" />
                </div>
    ...
    },
    {
      label: "Step 04",
      title: "Publish",
      description: "Instantly deploy your lightning-fast portfolio with custom domain configuration.",
      ...
      children: (
        <div className="flex flex-1 items-center justify-center p-4 mt-2 w-full">
          <div className="w-full max-w-[200px] rounded-xl border border-border/50 bg-background/60 p-4 shadow-sm space-y-3.5 text-center">
            ...
            <div className="space-y-1.5">
              <p className="text-[10px] font-semibold text-foreground">Custom Domains</p>
        ...
        <div className="flex flex-1 items-center justify-center p-4 mt-2 w-full">
          <div className="w-full max-w-[200px] rounded-xl border border-border/50 bg-background/60 overflow-hidden shadow-sm">
            ...
            <div className="p-3 text-center space-y-2">
              ...
              <div>
                <p className="text-[9px] font-semibold text-foreground">Deployment Active</p>
                <p className="text-[8px] text-muted-foreground font-mono">yousefdawood.me</p>
              </div>
            </div>
          </div>
        </div>
